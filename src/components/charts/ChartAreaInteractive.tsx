...
// Usa as variáveis CSS do design system (--chart-1, --chart-2, etc)
// =============================================================================
...
export interface ChartAreaInteractiveProps {
  ...
  /** Descrição do card */
  description?: string
  /** Dados do gráfico - array de objetos com date, desktop, mobile */
  data?: Array<{ date: string; desktop: number; mobile: number }>
  /** Config do gráfico - permite customização de labels e cores */
  config?: ChartConfig
...
export function ChartAreaInteractive({
  ...
  description = 'Mostrando visitantes totais nos últimos 3 meses',
  data = chartData,
  config = chartConfig,
  timeRangeOptions = [
  ...
  const filteredData = React.useMemo(() => {
    ...
    const daysToShow = selectedOption?.days || 90
  ...
  }, [timeRange, data, timeRangeOptions])
